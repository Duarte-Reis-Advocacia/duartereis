  ...
  return (
    ...
    >
      <div ref={ref} className={`container mx-auto px-4 grid md:grid-cols-2 gap-12 items-center relative z-10 transition-all duration-700 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
        ...
        <div>
          <span className={`inline-block text-primary text-sm font-semibold tracking-widest font-body origin-left transition-transform duration-500 ${isVisible ? "scale-x-100" : "scale-x-0"}`}>● DESDE 1999</span>
          <h2 className="font-heading text-3xl md:text-4xl mt-3 mb-6 text-white">Tradição, Ética e Resultado</h2>
          ...
          <div className="space-y-4 text-gray-300 font-body text-sm leading-relaxed">
