...
export default function CTAFinal() {
  ...
  return (
    <section id="contato" className="py-20 md:py-28 bg-black relative overflow-hidden">
      ...
      <div ref={ref} className={`container mx-auto px-4 text-center relative z-10 transition-all duration-700 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
        ...
        <a
          ...
          className="inline-flex items-center gap-3 bg-primary text-primary-foreground px-10 py-5 rounded-lg text-lg font-bold hover:bg-gold-light transition-colors duration-200 shadow-lg shadow-primary/20"
        >
